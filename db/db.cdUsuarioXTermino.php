<?php
/**
 * Table Definition for cd_usuario_x_termino
 */

class DataObject_CdUsuarioXTermino extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'cd_usuario_x_termino';            // table name
    ...
    public $idTermino;                       // int(11)  not_null primary_key
    public $fecha;                           // datetime(19)  binary

    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObject_CdUsuarioXTermino',$k,$v); }
    ...
    function table()
    {
         return array(
             ...
             'idTermino' =>  DB_DATAOBJECT_INT + DB_DATAOBJECT_NOTNULL,
    ...
    function keys()
    {
         return array('idUsuario', 'idMunicipio', 'idOcupacion', 'idCargo', 'idNivelEducacion', 'idTermino');
    }
